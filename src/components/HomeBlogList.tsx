...
export function HomeBlogList() {
  return (
    <div
      className="elementor-element elementor-element-04cc0ce e-flex e-con-boxed e-con e-parent"
      data-id="04cc0ce"
      data-element_type="container"
    >
      <div className="e-con-inner">
        <div
          className="elementor-element elementor-element-3c3f5d1 elementor-widget elementor-widget-arter-blog-carousel"
          data-id="3c3f5d1"
          data-element_type="widget"
          data-widget_type="arter-blog-carousel.default"
        >
